...
module.exports = {
  ...
  run: async (client, message, args) => {
    client.api.channels(conf.cezabilgikanal).messages.post({ data: {"content":"<:jail:903566151727087686> Aşağıda ki düğmelerden ceza listenizi, ceza puanını ve aktif cezanızın kalan süresini görüntüleyebilirsiniz.","components":[{"type":1,"components":[
